...
\author{Marko Ristic$^{1}$, Benjamin Noack$^{2}$, \IEEEmembership{Member, IEEE}, and Uwe D. Hanebeck$^{1}$, \IEEEmembership{Fellow, IEEE}
...
\begin{IEEEkeywords}
Encrypted State Estimation, Kalman Filtering, Stream Ciphers
\end{IEEEkeywords}
