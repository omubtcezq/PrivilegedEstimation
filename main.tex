...
% For unbiased - how about biased, when is this handled?
...
% However, due to the equivalent representation of measurements, models and estimation errors, we argue that the cryptographic indiscrepency does not affect the estimation error when estimates are made using the same representation, and state this assumption in section \ref{sec:scheme_security}.
