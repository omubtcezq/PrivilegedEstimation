...
%DIF ADD main.tex                  Fri Apr 23 12:11:23 2021
...
\begin{LaTeXdescription}
   ...
   \item[$\mathsf{Noise}(\mathsf{sk}, k, \mathcal{M}_S, \mathcal{M}_M, \vec{y}_1, \dots, \vec{y}_k)$] On input of secret key $\mathsf{sk}$, time step $k$, models $\mathcal{M}_S$ and $\mathcal{M}_M$, and measaurements \DIFdelbegin \DIFdel{$y_1,\dots,y_k$}\DIFdelend \DIFaddbegin \DIFadd{$\vec{y}_1,\dots,\vec{y}_k$}\DIFaddend , a noisy measurement $\vec{y}^\prime_k$ (with no required model constraints) is created.
